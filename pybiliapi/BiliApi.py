...
class BiliApi:
    ...
    def get_video_view(self, aid):
        return self.url_request('GET', 'https://api.bilibili.com/x/web-interface/view?aid={0}'.format(aid))
    ...
    def get_member(self, mid):
        return self.url_request('GET', 'https://api.bilibili.com/x/space/acc/info?mid={0}'.format(mid))

    def get_member_relation(self, mid):
        return self.url_request('GET', 'https://api.bilibili.com/x/relation/stat?vmid={0}'.format(mid))
